...
export default function App() {
  ...
  src="/logo.png"
  alt="Vowed Bond"
  className="h-64 w-auto object-contain -mt-20 -mb-28"
/>
          </button>
        ...
        <section id="top" className="pt-12 md:pt-16 pb-8 md:pb-12 text-center">
          <p className="text-emerald-400/90 uppercase tracking-[0.25em] text-[15px] md:text-xs font-semibold">
  ...
  instantly preview how it could answer customer questions.
      ...
      <button
        ...
        className="fixed bottom-54 right-4 z-50 w-16 h-16 rounded-full bg-slate-900 border border-emerald-400/60 shadow-[0_0_25px_rgba(16,185,129,0.35)] flex items-center justify-center hover:scale-110 transition duration-300 overflow-hidden"
      >
        <img
              ...
              <button
                ...
                onClick={() => {
                  ...
                  setMessages([
                    {
                      role: "bot",
                      text: `Hello ${cleaned}! ðŸ‘‹ How can I assist you today?`,
                      time: new Date().toLocaleTimeString([], {
                        hour: "2-digit",
                        minute: "2-digit"
                      })
